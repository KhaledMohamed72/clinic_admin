...
@section('header-title')    User Profile    @endsection
        ...
        <div class="col-md-3">
            ...
            <div class="card card-white card-outline">
                <div class="card-body box-profile">
                    ...
                    <h3 class="profile-username text-center">{{$row->user_name}}</h3>
                </div>
                <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card card-white">
                ...
                <div class="card-body">
                    <p class="text-muted text-center">
                        <a href="{{route('clinics.show',$row->clinic_id)}}">
                        <span class="badge bg-primary">{{$row->clinic_name}}</span>
                        </a>
                    </p>
                </div>
                <!-- /.card-body -->
